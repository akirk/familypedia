...
class Private_Site {
	...
	public function blog_privacy_selector() {
		...
		<label for="blog-private"><?php esc_html_e( 'Private, visible only to administrators, editors, and wiki users', 'familypedia' ); ?></label>
		<?php
	}
	...
	public function parse_request() {
		...
		<html>
		<head>
		<title><?php esc_html_e( 'This site is private.', 'familypedia' ); ?></title>
		</head>
		<body>
			<?php esc_html_e( 'This site is private.', 'familypedia' ); ?>
	...
	public function opml_head() {
		status_header( 403 );
		?>
		<error><?php esc_html_e( 'This site is private.', 'familypedia' ); ?></error>
	</head>
</opml>
		<?php
		exit;
	...
	public function bloginfo( $value, $what ) {
		if ( ( 'name' === $what || 'title' === $what ) && $this->is_private() ) {
			return __( 'This site is private.', 'familypedia' );
		}
