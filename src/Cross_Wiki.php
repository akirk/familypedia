...
class Cross_Wiki {
	const OPTION = 'familypedia_cross_wiki_sites';
	...
	private static function get_remote_page_data( $site, $slug ) {
		...
		// A peer wiki may still be a Family Wiki, keeping its people in pages.
		$page = get_page_by_path( $slug, OBJECT, Person::POST_TYPE );
		if ( ! $page ) {
