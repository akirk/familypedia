...
<head>
	...
	<title><?php echo wp_app_title( $familypedia_page_title ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- wp_app_title() runs its return value through esc_html(); escaping again would double-encode entities. ?></title>
	<?php wp_app_head(); ?>
</head>
